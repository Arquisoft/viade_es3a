...
*Level 1* 
It is displayed the white box description of the overall system together -- with blackbox descriptions of all contained building blocks.

image:doc_p5_level1.jpg["WhiteBox-Viade"]
...
==== Contained blackboxes <Name black box 1>
