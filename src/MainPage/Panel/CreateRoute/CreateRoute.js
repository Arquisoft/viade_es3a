                ...
                <div className="leftPanel_leftPart">     
                  ...
                  <nav className="leftPanel_leftPart">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="name" data-testid="inputName" placeholder="Route's name" />
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1" className="labelDescription" data-testid="desc">Description:</label>
                        <textarea className="form-control" id="description" data-testid="inputDesc" name="description" rows="3"  ></textarea>
                    </div>
                    ...
                    <div className="botones">
                        <button data-testid="btnenviar" className="btn btn-info" id="botonOpcion"> <SaveIcon /> Save </button>
